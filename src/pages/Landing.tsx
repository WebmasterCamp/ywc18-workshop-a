...
const description = '“Wetime” ได้แนวคิดมาจากคำว่า We ที่หมายถึง พวกเรา และ Time ที่หมายถึง เวลา ที่นำมารวมกันแล้วคือ การเข้ามาใช้เวลาร่วมกัน การทำงานร่วมกันมันเป็นอะไรที่น่าสนุกนะ แต่บางครั้งการทำงานร่วมกันก็กินเวลาจนหาข้อสรุปไม่ได้ Wetime จึงมีไอเดียอยากให้การประชุมไม่น่าเบื่อและจำเจ เอาหลักการแบ่งเวลามาปรับใช้ให้ทุกคน Produdctive มากขึ้น และยิ่งเป็นยุค New Normal แบบนี้ ถ้าแบ่งเวลาไม่ดี ยิ่งน่าปวดหัว'
const description2 = 'Wetime อยากช่วยให้ทุกคน Productive และทำงานง่าย ๆ เพราะแค่ทำงานที่บ้านก็เซ็งมากพอแล้ว อย่าให้การแบ่งเวลามาเป็นปัญหาของทุกคน พวกเราเองก็หวังว่าทุกคนจะทำงานได้อย่างราบรื่นจากเว็บไซด์ดี ๆ อย่าง Wetime ของเรานะ!'
...
export function Landing(): ReactElement {
  ...
  const Hero = (
    <Box padding="24px 64px" height="460px" position="relative">
      <Box width="540px">
        <Typography fontSize="48px" fontWeight={500} color="primary" lineHeight="54px">ใช้เวลาของคุณอย่างคุ้มค่า ไปกับ วีไทม์..</Typography>
      </Box>
  ...
  const Description = (
    <Box display="flex" marginTop="200px" flexDirection="column">
      ...
      <Box width="570px" margin="auto" marginTop="46px" color="#555555" textAlign="center">
